                ...
                <div
                    ...
                    <ul class="list-unstyled list-inline">
                        <li class="list-inline-item mr-lg-2 mr-0">
                            <a href="#">
                                <img style="{{$agent->isMobile() ? 'width: 60px' : ''}}"
                                     src="{{ asset('image/icons/instagram.webp') }}" alt="Instagram">
                            </a>
                        </li>
                        <li class="list-inline-item mr-lg-2 mr-0">
                            <a href="#">
                                <img style="{{$agent->isMobile() ? 'width: 60px' : ''}}"
                                     src="{{ asset('image/icons/telegram.webp') }}" alt="telegram">
                            </a>
                        </li>
                        <li class="list-inline-item mr-lg-2 mr-0">
                            <a href="#">
                                <img style="{{$agent->isMobile() ? 'width: 60px' : ''}}"
                                     src="{{ asset('image/icons/facebook.webp') }}" alt="facebook">
                            </a>
                        </li>
                        <li class="list-inline-item mr-lg-2 mr-0">
                            <a href="#">
                                <img style="{{$agent->isMobile() ? 'width: 60px' : ''}}"
                                     src="{{ asset('image/icons/odnoklassniki.webp') }}" alt="odnoklassniki">
                            </a>
                        </li>
                        <li class="list-inline-item mr-lg-2 mr-0">
                            <a href="#">
                                <img style="{{$agent->isMobile() ? 'width: 60px' : ''}}"
                                     src="{{ asset('image/icons/mail.webp') }}" alt="mail">
                            </a>
                        </li>
                        <li class="text-lg-left text-center mr-lg-2 mr-0">
                            <button class="btn text-white border-0 mt-4"
                                    style="background: linear-gradient(180deg, #F96C4D 0%, #F18936 100%); border-radius: 10px; padding: 7px 32px;">
                                {{ __('main.follow') }}
                            </button>
                        </li>
                    </ul>
