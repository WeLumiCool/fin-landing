...
@section('content')
    ...
    <div class="depozit container-fluid"
        ...
        <div class="depozit container pb-5 text-lg-left text-center px-lg-2 px-0"
             style="{{$agent->isDesktop() ? 'padding-top:90px' : 'padding-top: 20px;'}};">
            <div class="depozit row">
                <div class="depozit col-lg-7 col-12">
                    <div class="depozit col-lg-10 col-12">
                        <h1 class="depozit fin-title rubik"
                    ...
                    <div class="depozit col-12 pl-4" style="padding-top: 60px;">
                        <div class="depozit row">
                            @if($agent->isDesktop())
                                <div class="depozit d-flex mr-lg-5 mr-0">
                                    <div class="depozit text-center">
                                        <img src="{{ asset('image/20.webp') }}" style="width: 131px;" alt="">
                                        <p class="depozit fin-desc mb-0 pt-3">
                                            {{ __('main.banks') }}
                                        </p>
                                    </div>
                                </div>
    ...
    <div class="depozit container-fluid bg-white" id="depozit-about" style="padding: 65px 0px;">
        <div class="depozit container">
            <div class="depozit row">
                <div class="depozit col-lg-6 col-12">
                    <h2 class="depozit fin-title-2 rubik text-lg-left text-center"
                ...
                <div class="depozit col-lg-6 col-12 mt-lg-0 mt-3">
                    <div class="depozit row">
